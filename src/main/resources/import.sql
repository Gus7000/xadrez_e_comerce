...
-- Tabuleiros
insert into tabuleiro (tamanho, id_material, data_cadastro) values ('8x8', 1, '2026-04-09 08:20:00');
insert into tabuleiro (tamanho, id_material, data_cadastro) values ('10x10', 2, '2026-04-09 08:20:00');
insert into tabuleiro (tamanho, id_material, data_cadastro) values ('8x8 premium', 3, '2026-04-09 08:20:00');
...
-- Kits de peças
insert into kitpeca (data_cadastro) values ('2026-04-09 08:40:00');
insert into kitpeca (data_cadastro) values ('2026-04-09 08:41:00');
...
-- Relógios
insert into relogio (modelo, tipo, data_cadastro) values ('R2D2', 1, '2026-04-09 08:50:00');
insert into relogio (modelo, tipo, data_cadastro) values ('R2D3', 1, '2026-04-09 08:51:00');
insert into relogio (modelo, tipo, data_cadastro) values ('R2D4', 2, '2026-04-09 08:52:00');
insert into relogio (modelo, tipo, data_cadastro) values ('R2D5', 2, '2026-04-09 08:53:00');

-- Jogos completos
insert into jogocompleto (nome, preco, descricao, estoque_disponivel, id_fabricante, id_kit_peca, id_tabuleiro, id_relogio, data_cadastro) values ('Jogo Clássico Madeira', 449.90, 'Jogo completo com kit clássico e tabuleiro de madeira', 12, 1, 1, 1, 1, '2026-04-09 09:00:00');
insert into jogocompleto (nome, preco, descricao, estoque_disponivel, id_fabricante, id_kit_peca, id_tabuleiro, id_relogio, data_cadastro) values ('Jogo Premium Mármore', 899.90, 'Jogo completo premium para coleção e torneio', 4, 2, 2, 3, 3, '2026-04-09 09:01:00');
insert into jogocompleto (nome, preco, descricao, estoque_disponivel, id_fabricante, id_kit_peca, id_tabuleiro, data_cadastro) values ('Jogo Básico', 299.90, 'Jogo simples sem relógio incluso', 20, 1, 1, 2, '2026-04-09 09:02:00');
